...
})({"eg3nd":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d11ca20a766773a4";
"use strict";
...
},{}],"40mHp":[function(require,module,exports,__globalThis) {
...
},{"./belling":"5yY9l","./belling-dom":"4F59q"}],"5yY9l":[function(require,module,exports,__globalThis) {
...
},{}],"4F59q":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "audio", ()=>ut);
...
parcelHelpers.export(exports, "h1", ()=>le);
...
var R = (e, n, r)=>n.has(e) || V("Cannot " + r);
var w = (e, n, r)=>(R(e, n, "read from private field"), r ? r.call(e) : n.get(e)), T = (e, n, r)=>n.has(e) ? V("Cannot add the same private member more than once") : n instanceof WeakSet ? n.add(e) : n.set(e, r);
var t = class {
    constructor(n, r){
    ...
    render(n, r = document.createElement(this.name)) {
        ...
        if (this.dom = i, this._events) for(let o in this._events){
            let u = this._events[o];
            o === "unmount" ? n._addDestroyCallback(u) : i.addEventListener(o, u);
        }
        if (this._attr) for(let o in this._attr){
            ...
            typeof u == "function" ? n._watch((0, _belling.compute)(()=>{
                ...
                i.setAttribute(o, u.v);
            })) : i.setAttribute(o, u);
        }
        if (this._style) for(let o in this._style){
            let u = o, l = this._style[u];
        ...
        if (this.children) for (let o of this.children)if (typeof o == "string") {
            ...
            n._watch((0, _belling.compute)(()=>u.nodeValue = o())), i.appendChild(u);
        } else if (o instanceof (0, _belling.State) || o instanceof (0, _belling.Compute)) {
            let u = document.createTextNode("");
            n._watch((0, _belling.compute)(()=>u.nodeValue = o.v)), i.appendChild(u);
...
var y, M, v = class {
    constructor(n, r){
        ...
        T(this, M, []);
        this._whenDestroy = [];
        w(this, y).callback = B, this.dom = r.render(this), n == null || n.appendChild(this.dom);
    }
    _watch(n) {
...
function J(e, n, r) {
    ...
    function i(l, d) {
        for(let h = n.length; h < l; h++)n.push(-1);
        n[l] = d;
    }
    let c = 0, o = e.length;
    for(; c < o && e[c] == -1; c++);
    for(r[0] = c; c < o; c++){
        ...
        for(; h < m;)a = h + m >> 1, e[r[a]] < l ? h = a + 1 : m = a;
        let p = h;
        l < e[r[p]] && (p > 0 && i(c, r[p - 1]), r[p] = c);
    }
    c = r.length;
    let u = r[r.length - 1];
    if (u > e.length) return r;
    for(; c-- > 0;)r[c] = e[u], u = n[u];
    return r;
}
var F = [], P = [], A = [], I = [], L, _, E = class extends t {
    constructor(r, i, c){
        super(r);
        T(this, L, new Map);
        T(this, _, new Map);
    ...
    render(r) {
        let i = super.render(r), c = this.list, o = w(this, L), u = this.f, l = w(this, _), d = [];
        function h() {
            let a = F;
            a.length = 0;
            let p = c.v;
            ...
            i.childNodes.forEach((s)=>g.push(s)), d.forEach((s)=>{
                ...
                s != -1 && (l.get(f)._destroy(), l.delete(f), o.delete(f), i.removeChild(g[s]));
            });
            let G = J(a, P, A), q = 0;
            p.forEach((s, f)=>{
                let S = a[f], N = G[q];
                if (S == -1) {
                    let b = new v(void 0, u(s));
                    if (f == p.length - 1 ? i.appendChild(b.dom) : i.insertBefore(b.dom, g[N]), o.has(s)) {
                        d.push(b);
                        return;
                    }
                    l.set(s, b);
                } else S == N ? q++ : i.insertBefore(g[S], g[N]);
                o.set(s, f);
            }), F.length = P.length = A.length = I.length = 0;
        }
    ...
    constructor(r){
        ...
        let i = ()=>{
            ...
            if (this._ele = c, this._events = c._events, this._attr = c._attr, this._style = c._style, this._ref = c._ref, this.children = c.children, (o = this._root) == null || o._destroy(), this._root = new v(void 0, c), this.dynDom) {
                let u = this.dynDom.parentNode;
                u && u.replaceChild(this._root.dom, this.dynDom);
            }
            this.dynDom = c.dom;
        };
...
function te(e, n, r) {
    ...
    return new E(e, (0, _belling.compute)(()=>{
        ...
        return o.forEach((u, l)=>{
            let d = i.get(u);
            d ? d.v = l : i.set(u, (0, _belling.state)(l));
        }), o;
    }), (o)=>r(i.get(o), o));
}
function ne(e) {
...
},{"belling":"1fOAk","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"1fOAk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Compute", ()=>m);
parcelHelpers.export(exports, "State", ()=>C);
parcelHelpers.export(exports, "Stop", ()=>v);
parcelHelpers.export(exports, "Watcher", ()=>A);
parcelHelpers.export(exports, "compute", ()=>z);
parcelHelpers.export(exports, "makeArr", ()=>_);
parcelHelpers.export(exports, "state", ()=>I);
parcelHelpers.export(exports, "watcher", ()=>M);
var W = (r, t, e)=>{
    if (!t.has(r)) throw TypeError("Cannot " + e);
};
var x = (r, t, e)=>(W(r, t, "read from private field"), e ? e.call(r) : t.get(r)), k = (r, t, e)=>{
    if (t.has(r)) throw TypeError("Cannot add the same private member more than once");
    t instanceof WeakSet ? t.add(r) : t.set(r, e);
}, E = (r, t, e, n)=>(W(r, t, "write to private field"), n ? n.call(r, e) : t.set(r, e), e);
var { max: j, min: p } = Math;
function w(r, t) {
    return p(r < 0 ? j(0, t + r) : r, t - 1);
}
function c(r, t, e) {
    if (r.length == 0 || t == 0 && e == r.length) return r;
    if (r.data) {
        let n = new T;
        return n.off = t + r.off, n.length = e, n.data = r.data, Object.freeze(n), n;
    } else {
        let { left: n, right: i } = r;
        if (!(n instanceof T && i instanceof T)) throw new TypeError;
        if (t > n.length) return c(i, t - n.length, e);
        if (t + e < n.length) return c(n, t, e);
        let s = new T, o = n.length - t;
        return s.left = c(n, t, o), s.right = c(i, 0, e - o), s.length = e, s;
    }
}
function O(r, t) {
    let e = new T;
    return e.left = r, e.right = t, e.length = t.length + r.length, e;
}
function _(...r) {
    let t = new T;
    return t.data = r, t.length = r.length, t;
}
var T = class r {
    constructor(){
        this.length = 0;
    ...
    subarray(t, e) {
        return t = w(t, this.length), e = p(this.length - t, e), c(this, t, e);
    }
    unshift(...t) {
        return t.length <= 0 ? this : _(...t).concat(this);
    }
    ...
    insert(t, ...e) {
        return t = w(t, this.length), t == 0 ? this.unshift(...e) : t == this.length ? this.push(...e) : c(this, 0, t).concat(c(this, t, this.length - t).unshift(...e));
    }
    delete(t, e) {
        t = w(t, this.length);
        let n = t + e, i = t == 0, s = n >= this.length;
        return i && s ? F : i ? c(this, n, this.length - n) : s ? c(this, 0, t) : c(this, 0, t).concat(c(this, n, this.length - n));
    }
    splice(t, e, ...n) {
        t = w(t, this.length);
        let i = t + e, s = t == 0, o = i >= this.length;
        return s && o ? F : s ? c(this, i, this.length - i).unshift(...n) : o ? c(this, 0, t).push(...n) : c(this, 0, t).push(...n).concat(c(this, i, this.length - i));
    }
    set(t, e) {
    ...
    at(t) {
        ...
        } else if (t >= e.length) return;
        for(; e.left instanceof r;){
            let { left: n, right: i } = e;
            n.length > t ? e = n : (e = i, t -= n.length);
        }
        if (!e.data) throw new Error;
        return e.data[t + e.off];
    }
    forEach(t) {
        let e = 0;
        function n(i) {
            if (i.data) for(let s = i.off, o = s + i.length; s < o; s++)t(i.data[s], e++);
            else {
                if (!(i.left instanceof r && i.right instanceof r)) throw new TypeError;
                n(i.left), n(i.right);
            }
        }
        n(this);
    ...
    every(t) {
        ...
        function i(s) {
            if (s.data) {
                for(let o = s.off, f = o + s.length; o < f; o++)if (t(s.data[o], e++) == !1) {
                    n = !0;
                    return;
                }
            } else {
                if (!(s.left instanceof r && s.right instanceof r)) throw new TypeError;
                i(s.left), n || i(s.right);
            }
        }
        return i(this), !n;
    }
    forEachInRange(t, e, n) {
        t = w(t, this.length), e = p(this.length - t, e);
        let i = t, s = !1;
        function o(f, h, u) {
            if (h != u) {
                if (f.data) {
                    let a = f.off, g = a + u;
                    for(a += h; a < g; a++)if (n(f.data[a], i++) == v) {
                        s = !0;
                        return;
                    }
                } else {
                    if (!(f.left instanceof r && f.right instanceof r)) throw new TypeError;
                    let a = f.left, g = f.right, l = a.length;
                    h >= l ? o(g, h - l, u - l) : u <= l ? o(a, h, u) : (o(a, h, l), s || o(g, 0, u - l));
                }
            }
    ...
    forEachInRangeReversed(t, e, n) {
        t = w(t, this.length) + 1;
        let i = j(t - e, 0), s = t, o = !1;
        function f(h, u, a) {
            if (u != a) {
                if (h.data) {
                    for(u += h.off, a += h.off - 1; a >= u; a--)if (n(h.data[a], s--) == v) {
                        o = !0;
                        return;
                    }
                } else {
                    if (!(h.left instanceof r && h.right instanceof r)) throw new TypeError;
                    let g = h.left, l = h.right, b = g.length;
                    u >= b ? f(l, u - b, a - b) : a <= b ? f(g, u, a) : (f(l, 0, a - b), o || f(g, u, b));
                }
            }
        }
        f(this, i, t);
    ...
    map(t) {
        ...
        let n = 0;
        function i(s) {
            if (s.data) for(let o = s.off, f = o + s.length; o < f; o++)e[n++] = t(s.data[o], o);
            else {
                if (!(s.left instanceof r && s.right instanceof r)) throw new TypeError;
                i(s.left), i(s.right);
            }
    ...
    flat() {
        ...
        let e = 0;
        function n(i) {
            if (i.data) for(let s = i.off, o = s + i.length; s < o; s++)t[e++] = i.data[s];
            else {
                if (!(i.left instanceof r && i.right instanceof r)) throw new TypeError;
                n(i.left), n(i.right);
            }
...
function D(r) {
    ...
    let t = r._Consumer;
    for (let i of t)if (typeof i != "number") {
        if (i == d) throw new Error;
        i._Dirty || (i._Dirty = !0, D(i));
    }
    let e = r._Watchers;
    e && (e instanceof Array ? e.forEach((i)=>{
        var s;
        return (s = i._Func) == null ? void 0 : s.call(i, r);
    }) : (n = e._Func) == null || n.call(e, r));
}
var y, C = class {
    constructor(t){
        this._Consumer = [];
    ...
    get v() {
        return d && d._GetCallback(this), x(this, y);
    }
    set v(t) {
        if (x(this, y) != t) {
            E(this, y, t);
...
y = new WeakMap;
function R(r) {
    if (!(r instanceof m) || !r._Dirty) return;
    let t = r._Producer;
    t.length = 0;
    let e = d;
    d = r;
    try {
        r._v = r._Func(), r._Err = void 0;
    } catch (n) {
        r._Err = n;
    }
    r._Dirty = !1, d = e;
...
var m = class {
    ...
    _GetCallback(t) {
        let e = t._Consumer;
        e.indexOf(this) < 0 && (e.push(this), this._Producer.push(t));
    }
    get v() {
        if (d && d._GetCallback(this), R(this), this._Err) throw this._Err;
        return this._v;
    }
    get error() {
        return this._Err;
...
function S(r) {
    if (!(r instanceof m)) return;
    let t = r._Producer;
    for (let e of t){
        let n = e._Consumer.indexOf(r);
        e._Consumer.splice(n, 1), r instanceof m && !e._Watchers && e._Consumer.length == 0 && S(e);
    }
    t.length = 0;
}
var A = class {
    ...
    watch(...t) {
        for (let e of t){
            let n = e._Watchers;
            if (!n) e._Watchers = this;
            else if (n instanceof Array) {
                if (n.indexOf(this) > -1) continue;
                n.push(this);
            } else n != this && (e._Watchers = [
                this,
                n
            ]);
            e instanceof m && R(e), this.watchList.add(e);
        }
    }
    unwatch(...t) {
        for (let e of t.length > 0 ? t : this.watchList.values()){
            let n = e._Watchers;
            if (n) {
                if (this.watchList.delete(e), n instanceof Array) {
                    let i = n.indexOf(this);
                    if (i > -1 && n.splice(i, 1), n.length > 0) continue;
                } else e._Watchers = void 0;
                S(e);
            }
        }
    }
...
function M(r) {
    let t = new A;
    return t.callback = r, t;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}]},["eg3nd","40mHp"], "40mHp", "parcelRequire94c2")

//# sourceMappingURL=demo.766773a4.js.map
